...
-- spHorasExtrasAgregar
DECLARE 
	 @UsuarioId		varchar(50) 
	,@InfoXml		xml
	,@HorasExtrasId	bigint		--OUTPUT
SELECT  @UsuarioId = 'glavayen' --'cguznay'
SELECT	@InfoXml = N'<HOREXT CODEMP="9275" FECHAM="2017-08-15" INGRES="08:30" SALIDA="19:30" LABORA="11:00" ATRASA="00:00" ANTICI="00:00" 
HORA00="00:00" HORA50="02:00" HOR100="00:00" HORPER="00:30" HORREC="00:00" JUSTIF="prueba1" ANIOPE="2017" PERIOD="9" HOREXT="" ACTIVO="True"  /> '
-----------------------------------------------------------------------------------------------------------------------------------------------------
BEGIN TRY
	...
	--SELECT   @horas50			as '@horas50'
	--		,@minutos50			as '@minutos50'
	--		,@horas100			as '@horas100'
	--		,@minutos100		as '@minutos100'
	--		,@horasPermiso		as '@horasPermiso'
	--		,@minutosPermiso	as '@minutosPermiso'
	--		,@horasRecuperar	as '@horasRecuperar'
	--		,@minutosRecuperar	as '@minutosRecuperar'
...
-- DELETE FROM tbAprobaciones

-- select * from tbHorasExtras
-----------------------------------------------------------------------------------------------------------------------------------------------------
