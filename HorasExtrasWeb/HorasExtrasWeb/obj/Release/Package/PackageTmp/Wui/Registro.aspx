    ...
    <div id="NewReg2" runat="server" visible="false">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="IngresoTxt" runat="server" onkeyup="mascara(this,':',patron,true)" Width="70px" />
                </td>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Salida:"/>
                </td>
                <td>
                    <asp:TextBox ID="SalidaTxt" runat="server" onkeyup="mascara(this,':',patron,true)" Width="70px" />
                </td>
                <td>
                ...
                <td class="w3-tiny w3-text-red">
                    <asp:CompareValidator ID="CompFechaIni" runat="server" ErrorMessage="La fecha no puede ser inferior a Desde" ControlToValidate="FechaTxt" 
            ...
            <tr>
                ...
                <td colspan="2" class="w3-tiny w3-text-red">
                    <asp:CompareValidator ID="ComFechFin" runat="server" ErrorMessage="La fecha no puede ser superior a Hasta" 
